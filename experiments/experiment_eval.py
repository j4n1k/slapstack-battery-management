...
run_id = "waj0fjc3" # "f8l4u7x4" # "waj0fjc3"         # ID of the specific run
...
thresholds = [30, 40, 50, 60, 70, 80, 90, 100, "random"]
...
result_melt = pd.melt(result_df, id_vars=["Strategy"], value_vars=[
    30, 40, 50, 60, 70, 80, 90, 100, "random", "PPO"], var_name="Threshold")

th_comp_df = result_df[["Strategy", 30, 40, 50, 60, 70, 80, 90, 100, "random", "PPO"]]
th_comp_df.rename(columns={"Strategy": "Partition"}, inplace=True)

th_comp_df = th_comp_df.set_index("Partition")
subset_min = [
    30, 40, 50, 60, 70, 80, 90, 100, "random", "PPO"
]
